...
function sendNFTs() {
  ...
  async function storeNft() {
    ...
    const metadata = await client.storeBlob(blobImage);
  ...
  async function mintNft() {
    ...
    const txn = await contract.mint(
      ...
      "0xf701D829de7ecD724f674C00fD714936Fa510ce8",
      0,
      correctAddress,
      ipfs,
    );
      ...
      <div>
        <div className="card lg:card-side bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            />
            <button onClick={checkAddress} className="btn btn-primary">
            ...
            <div className="card-actions justify-end">
              <button onClick={storeNft} className="btn btn-neutral">
                {" "}
    ...
    <button>close</button>
              ...
              <dialog id="my_modal_2" className="modal">
                <div className="modal-box">
                  ...
                  <button onClick={mintNft} className="btn btn-neutral">
                    Yes mint the NFT to the users address{" "}
                  </button>
                </div>
